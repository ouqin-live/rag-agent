...
| 优化方向 | 优先级 | 状态 | 说明 |
|---|---|---|---|
| 混合检索（BM25 + Dense） | P0 | ✅ 已完成 | Dense + BM25 + RRF 融合 |
| 重排序模型 | P1 | ✅ 已完成 | EmbeddingReranker，复用已有 embedder |
| 语义分块 | P1 | ✅ 已完成 | SemanticChunker，按话题边界切分 |
| 分块策略可配置化 | P2 | 待实现 | 降低运维复杂度 |
| URL 加载增强 | P2 | 待实现 | 网络场景的文档接入体验 |
| 增量更新优化 | P3 | 待实现 | 大文档场景性能优化 |
| 多模态支持 | P3 | 待实现 | 扩展应用场景 |
